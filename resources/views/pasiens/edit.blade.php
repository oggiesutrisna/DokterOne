...
@section('subtitle', 'Modify patient record and examination result')
@section('content')
<div class="patient-form-card">
    <div class="patient-form-header">
        <div class="patient-form-title">
            <span class="patient-form-icon"><i class="fas fa-user-edit"></i></span>
    ...
    <form action="{{ route('pasiens.update', $pasien) }}" method="POST">
            ...
            <div class="form-section">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" name="nosurat" id="nosurat" class="form-control @error('nosurat') is-invalid @enderror" placeholder="ex: UC/EX/2012" value="{{ old('nosurat', $pasien->nosurat) }}" required>
                        @error('nosurat')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama" id="nama" class="form-control @error('nama') is-invalid @enderror" placeholder="ex: Rahmat Joget" value="{{ old('nama', $pasien->nama) }}" required>
                        @error('nama')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="dob" id="dob" class="form-control @error('dob') is-invalid @enderror" value="{{ old('dob', $pasien->dob) }}" required>
                        @error('dob')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nomor_pid" id="nomor_pid" class="form-control @error('nomor_pid') is-invalid @enderror" placeholder="Enter passport or ID number" value="{{ old('nomor_pid', $pasien->nomor_pid) }}" required>
                        @error('nomor_pid')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nationality" id="nationality" class="form-control @error('nationality') is-invalid @enderror" placeholder="ex: Indonesian, Russian, Indian" value="{{ old('nationality', $pasien->nationality) }}" required>
                        @error('nationality')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
            ...
            <div class="form-section">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="datetime-local" name="sampling_time" id="sampling_time" class="form-control @error('sampling_time') is-invalid @enderror" value="{{ old('sampling_time', $pasien->sampling_time ? \Carbon\Carbon::parse($pasien->sampling_time)->format('Y-m-d\TH:i') : '') }}" required>
                        @error('sampling_time')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('result') is-invalid @enderror" name="result" id="result" required>
                            ...
                            <option value="Negative" {{ old('result', $pasien->result) == 'Negative' ? 'selected' : '' }}>Negative</option>
                            <option value="Positive" {{ old('result', $pasien->result) == 'Positive' ? 'selected' : '' }}>Positive</option>
                        </select>
                        @error('result')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
        ...
        <div class="patient-form-footer">
            ...
            <button type="submit" class="btn btn-warning" style="background-color: var(--warning); border-color: var(--warning); color: #fff;">
